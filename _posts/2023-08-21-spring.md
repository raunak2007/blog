    ...
    <div>
        <div style="float: right; margin: 0px 10px 10px 0px;">
            <a href="https://github.com/nighthawkcoders/spring_portfolio">
                <img atl="Frontend Files" src="https://nighthawkcoders.github.io/APCSA/images/frontend.png" title="VS Code frontend files"
                width="250">
            </a>
        </div>
        <div>
...
<div>
    <div>
        <div style="float: right; margin: 0px 10px 10px 0px;">
            <a href="https://github.com/nighthawkcoders/spring_portfolio">
                <img atl="Frontend Files" src="https://nighthawkcoders.github.io/APCSA/images/resources.png" title="VS Code frontend files"
                width="250">
            </a>
        </div>
        <div>
